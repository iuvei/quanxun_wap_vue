    ...
    export default {
        ...
        methods: {
            ...
            request_content() {
                ...
                this.$http({
                    method: "get",
                    url: httpUrl.activity_info_url,
                    params: {id: id}
                }).then(res => {
                    if (res.status == 200) {
                        let data = eval(res.data)
                        let a_content_info = data[0].a_content_info;
                        this.a_title = data[0].a_title
                        this.a_starttime = data[0].a_starttime.slice(0, 10)
                        this.a_endtime = data[0].a_endtime.slice(0, 10)
